Event.observe(window, 'load', function() {
    ...
    if(payment.isOneStepCheckout){
        ...
        payment.isOneStepCheckout.each(function(elem){
            if(Prototype.Browser.IE && (parseInt(navigator.userAgent.substring(navigator.userAgent.indexOf("MSIE")+5)) == 7 || parseInt(navigator.userAgent.substring(navigator.userAgent.indexOf("MSIE")+5)) == 8)) {
                return;
            }
